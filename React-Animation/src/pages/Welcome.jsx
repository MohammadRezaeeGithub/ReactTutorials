...
export default function WelcomePage() {
  ...
  //this hook accepts 3 arguments,
  //the first one is the value that must be transformed,
  //the second one is the breakpoints for the transition
  //and the third one is the values that must the breakpoints be transformed to.
  const cityOpacity = useTransform(scrollY, [0, 200], [1, 0.5]);

  //this one will controll the y position of the image, it makes like a parallax effect
  ...
  return (
    <>
      <header id="welcome-header">
        ...
        {/* here when can add the vairable above in style property and it will be watched by framer motion */}
        <motion.img
